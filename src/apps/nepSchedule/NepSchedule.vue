...
export default defineComponent({
    ...
    computed: {
        nepDisplayCondition() {
            ...
            switch (theme) {
                case 'summer':
                    shouldDisplay = this.streamsThisWeek.length <= 3;
                    break;
                default:
                    shouldDisplay = this.streamsThisWeek.length <= 2 || (this.windowWidth >= 2000 && this.windowHeight >= 780);
            }
